...
| **Pro_Designer** | Design | The entire design system: `design/design.md` + 9 per-page designs — 5 design laws, tokens, motion vocabulary, 64-loader registry table, flagship specs |
...
| **docs-system** | Docs | Architecture page (encoding, dictionary, interactive Fu Xi map) + Usage page (install, tokens, inversion, reduced motion) |
